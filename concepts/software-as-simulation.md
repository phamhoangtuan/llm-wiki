...
aliases: [software simulation, code as model]
---
...
- Grounded in [[bijection]] — the 1-1 mapping between reality and code
- Contrasts with procedural programming — objects as data holders vs. behavioral entities
- Related to [[linguistic-relativity]] — the language you use shapes how you perceive the domain
